...
import com.technource.android.utils.Constants.NOTIFICATION_CHANNEL_ID
import java.io.File
...
class FloatingService : Service() {
    ...
    private fun setupRecyclerView() {
        ...
        recyclerView.adapter = ActionAdapter(listOf(
            ...
            Action(R.drawable.ic_camera, ::captureCamera),
            Action(R.drawable.ic_notes, ::showNotesDialog),
            ...
            Action(R.drawable.ic_settings, ::quickSettings)
        ))
    }
